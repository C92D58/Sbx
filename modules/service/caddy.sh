...
# for more info, see https://doc.wahsun.org/$is_core/caddy-auto-tls/
# 不要編輯这个檔案 #
# 更多相关請阅读此文章: https://doc.wahsun.org/$is_core/caddy-auto-tls/
...
reverse_proxy https://$proxy_site {
    ...
    [[ $1 != "new" && $1 != 'proxy' ]] && {
        [[ ! -f ${is_caddy_site_file}.add ]] && echo "# see https://doc.wahsun.org/$is_core/caddy-auto-tls/" >${is_caddy_site_file}.add
    }
}
